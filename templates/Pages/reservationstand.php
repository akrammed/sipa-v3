<section id="reservation-choice" class="py-5 bg-light">
 <div class="container section-title" data-aos="fade-up">
                <h2>Choisissez le type d'inscription</h2>
                <p>Veuillez sélectionner le formulaire correspondant à votre statut d'exposant</p>
            </div>
