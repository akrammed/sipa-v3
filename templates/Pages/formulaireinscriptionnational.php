...
<main class="container mb-5">
    <div class="form-container" data-aos="fade-up">
        ...
        <?= $this->Form->create(null, [
            'url' => ['controller' => 'Emails', 'action' => 'national'],
            'method' => 'POST',
        ...
        <h4 data-aos="fade-right" class="mt-5 mb-4">Réservation de Stand</h4>
        <div data-aos="fade-up">
            <div class="floating-label mb-4">
                <select class="form-select" id="stand_type" name="stand_type" required>
                    <option value=""></option>
                    <option value="amenage">Stand aménagé - 15.000 DA/m²</option>
                    <option value="non_amenage">Stand non aménagé - 11.000 DA/m²</option>
                    <option value="decouvert">Emplacement découvert - 8.000 DA/m²</option>
                </select>
